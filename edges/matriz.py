...
print([e.duration for e in m._edges])
#--------------------------------------------  
# Guardar instancia
# Exportar en .pkl
# problem = m.data()
# with open("edges/problem-m.pkl", "wb") as f:
#     pickle.dump(problem, f)
# with open("edges/modelo-m.pkl", "wb") as f:
#     pickle.dump(m, f)
#-------------------------------------------- 
...
# print(res.best)
# edges_matrix = sorted(
#     [(e.frm.id, e.to.id, e.distance, e.duration) for e in m._edges]
# )
# print(edges_matrix)